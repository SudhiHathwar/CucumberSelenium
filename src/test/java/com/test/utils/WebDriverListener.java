...
import com.test.config.ExtentTestFactory;
import com.test.config.PropertyReader;
...
public class WebDriverListener implements IInvokedMethodListener, ITestListener, IRetryAnalyzer {
    ...
    private static ExtentHtmlReporter getHtmlReporter() {
        ...
        htmlReporter.config().setDocumentTitle("Responsive Seasons Automation");
        htmlReporter.config().setReportName("Seasons Execution Report");
